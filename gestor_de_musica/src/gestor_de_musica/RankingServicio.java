...
public class RankingServicio {
    ...
    // Monticulo de maximos para ordenar las canciones por reproducciones
    ...
    public RankingServicio() {
        // Se usa un comparador inverso basado en el numero de reproducciones
    ...
    public void actualizarReproduccion(Cancion c) {
        // Se remueve la cancion antes de modificarla para no corromper el heap
        maxHeap.remove(c);
        
        // Se incrementa el contador de reproducciones de la cancion
        c.incrementarReproducciones();
        
        // Se reinserta la cancion actualizada en el heap para reordenarla
        maxHeap.add(c);
    }
    ...
    // Devuelve el heap original (util para propositos de testeo)
